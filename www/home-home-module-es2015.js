...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatusUserLoggin", function() { return StatusUserLoggin; });
const StatusUserLoggin = {
    LOGGED: 'logged',
    RELOGGED: 'relogged'
};
...
let HomePage = class HomePage {
    ...
    isLogged() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const user = yield this.isValidIdUser();
            if (user) {
