...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"loading-container\" [style.height]=\"height\">\n  <ion-icon name=\"refresh-outline\" [style.color]=\"color\"></ion-icon>\n</div>\n");
...
/* harmony import */ var _ux_loading_loading_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../ux/loading/loading.module */ "./src/app/ux/loading/loading.module.ts");
...
ComponentsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _ux_loading_loading_module__WEBPACK_IMPORTED_MODULE_15__["LoadingModule"]
        ],
        exports: components
    })
], ComponentsModule);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateUserPhotoSuccess", function() { return updateUserPhotoSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateUserPhotoFailure", function() { return updateUserPhotoFailure; });
...
// UPDATE PHOTO USER
const updateUserPhoto = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Update Photo User] Update Photo User', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const updateUserPhotoSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Update User Photo Success] Update Photo User Success');
const updateUserPhotoFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Update User Photo Failure] Update Photo User Failure');
// UPDATE USER
...
let AuthenticationEffects = class AuthenticationEffects {
    constructor(actions$, firebase, router) {
        ...
        // UPDATE USER
        this.updateUserPhoto$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_store_actions_actions__WEBPACK_IMPORTED_MODULE_6__["updateUserPhoto"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(({ user }) => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(this.firebase.actualizarDatos('usuario-app', user, user.id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => {
                sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire('Bien Hecho', 'Datos actualizados correctamente', 'success');
