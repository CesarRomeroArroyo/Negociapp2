...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsFormFormComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FormComponent = /*#__PURE__*/function (_abstract_form_abstac2) {
      ...
      function FormComponent(formBuilder, firebase, uniqueId, state, fileManager, loadingController, oneSignal) {
        var _this4;
      ...
      _createClass(MycardsComponent, [{
        ...
        value: function goToEdit(item) {
          if (item.offerit.length === 0) {
            this.router.navigate(["/category/".concat(this.category, "/form/").concat(item.uniqueid)]);
          } else {
